...
import com.idp.pages.VisitWebSiteFunctionality;
import com.idp.utilities.FilePaths;
import com.relevantcodes.extentreports.ExtentReports;

public class VisitWebSiteCase {
    ...
    public Object[][] loginData() throws Exception {
        Object[][] arrayObject = Commanmethod.getTestData("VisitWebsite");     
        return arrayObject;
    }
 
	@Test(dataProvider="excelData")
	public static void newsearchf(String url, String visitweburl, String providername, String affiliate) throws InterruptedException, IOException, SQLException 
	{
		
		VisitWebSiteCase newvweb = new VisitWebSiteCase();
		Commanmethod.openBrowser(url);
		newvweb.newvwebfunct(url,visitweburl,providername,affiliate);
		
	}
	
	public static void newvwebfunct(String url, String visitweburl, String providername, String affiliate) throws InterruptedException, IOException, SQLException
	{
		VisitWebSiteFunctionality vbf = PageFactory.initElements(Commanmethod.driver, VisitWebSiteFunctionality.class);
		vbf.newvwebtwo(url,visitweburl,providername,affiliate);
